...
const bookingSteps = [
  {
    icon: "/assets/step-icon-1.png", // Path to the yellow location icon
    title: "Choose Destination",
    desc: "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Urna, tortor tempus."
  },
  {
    icon: "/assets/step-icon-2.png", // Path to the orange payment icon
    title: "Make Payment",
    desc: "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Urna, tortor tempus."
  },
  {
    icon: "/assets/step-icon-3.png", // Path to the blue airport icon
  ...
  return (
    <section className={styles.bookWrapper}>
      <div className={styles.container}>
        ...
        {/* Right Side: Floating and Overlapping Cards */}
        <div className={styles.cardsColumn}>
          ...
          {/* Overlapping Card (Trip to Rome - *Crucial Fix*) */}
